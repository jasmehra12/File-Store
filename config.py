...
#Your db channel Id
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1002034681694")
# NAMA OWNER
...
START_PIC = os.environ.get("START_PIC", "https://i.ibb.co/h1w77b3g/x.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://i.ibb.co/1GFvnCD3/x.jpg")
